			...
			<form method="POST" action="<?php print JURI::root(true)?>/modules/mod_jmlogin/ajax_login.php" id="login-form" class="form-horizontal" >
				...
				<div class="userdata">
					<div class="jmemail">
						...
						<input type="text" id="login_user_email" class="inputbox" name="username" placeholder="<?php echo $field_username; ?>"/>
					</div>
					
					<div class="jmpassword">
						<span><i class="fa fa-lock"></i></span>
						<input type="password" id="login_pass" class="inputbox" name="password" placeholder="<?php echo $field_password; ?>"/>
					</div>
					...
					<div class="jmsubmit">
						<input type="submit" name="login" id="jm-login-btn" class="btn-jm-submit" value="Sign me in"/></div>
