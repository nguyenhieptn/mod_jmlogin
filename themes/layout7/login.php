...
?>
	<div id="jmlogin" class="jmlayout7 jmlogin jm_login">
		<div class="jm-inner">
			<div class="jm-title"><?php echo $jm_login_title!=''?$jm_login_title:JText::_('MOD_JM_LOGIN_TITLE')?></div>
				
			
			<form method="POST" action="<?php echo JRoute::_('index.php', true)?>" id="jm-login-form" class="jm-layout7-form jm-form-horizontal" >
