...
?>
	<div id="jmlogin" class="jmlayout6 jmlogin jm_login">
		<div class="jm-inner">
			<div class="jmhead">
				<div class="jm-title"><?php echo $jm_login_title!=''?$jm_login_title:JText::_('MOD_JM_LOGIN_TITLE')?></div>
				<div class="jmheadright jmwidth"><a href="#">Create Account</a></div>
			</div>
			
			<form method="POST" action="<?php echo JRoute::_('index.php', true)?>" id="jm-login-form" class="jm-layout6-form jm-form-horizontal" >
            <div class="jm-error" id="jm-login-error"></div>
				<div class="jm-userdata">
					...
					<div class="jmform_bottom">
						<div class="jm-submit input jm-width">
					...
					<div class="jmbottom">
						<ul>
							...
							<li><a class="jm-forgot-password" href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>" data-tabid="#regain_password" data-tab="jmtab" data-toggle="jmmodal"><?php echo JText::_('JM_FORGOT_YOUR_USERNAME'); ?></a></li>
