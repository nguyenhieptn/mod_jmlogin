...
?>
<div id="jmregister" class="jmlayout6 jmregister jm_login">
		<div class="jm-inner">
			<div class="jm-title">Register</div>
			<form method="POST" id="jm-form-register" class="jm-layout6-form form-horizontal" action="<?php echo JRoute::_('index.php', true); ?>" >
