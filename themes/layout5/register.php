...
?>
<div id="jmregister" class="jmlayout5 jmregister jm_login">
		<div class="jm-inner">
			<div class="jm-title"><?php echo $jm_register_title!=''?$jm_register_title:JText::_('MOD_JM_LOGIN_REGISTRER_TITLE')?></div>
			<form method="POST" id="jm-form-register" class="jm-layout5-form form-horizontal" action="<?php echo JRoute::_('index.php', true); ?>" >
