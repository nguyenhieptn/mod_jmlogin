...
<div id="jmlogin" class="jmlogin jm-tab-content" >
    <form action="<?php print JURI::root(true)?>/modules/mod_jmlogin/ajax_login.php" method="POST" class="form-horizontal" id="jm-login-form">
        ...
        <div class="jm-control-group">
            <div class="controls-label">
                <div class="jm-label-wrap clearfix">
                    <label for="login_user"><?php echo $field_username; ?></label>
                </div>
            </div>
        ...
        <div class="im-login-footer">
            <a class="float-left" href="#jmmodal" data-tabid="#regain_password" data-tab="jmtab" data-toggle="jmmodal"><?php echo JText::_("Forgot password?"); ?></a>
            <a class="float-right" href="#jmmodal" data-tabid="#jmregister" data-tab="jmtab" data-toggle="jmmodal"><?php echo JText::_("New Account Singup"); ?></a>
            <div class="clear"></div>
        </div>
    ...
    <div class="jm-login-footer">
        ...
        <a class="social float-right" href="#"><img alt="Google+" src="<?php echo JURI::base(true) . '/modules/mod_jmlogin/assets/images/google.png'; ?>"/></a>
        <a class="social float-right" href="#"><img alt="Twitter" src="<?php echo JURI::base(true) . '/modules/mod_jmlogin/assets/images/twitter.png'; ?>"/></a>
        <a class="social float-right" href="#"><img alt="Facebook" src="<?php echo JURI::base(true) . '/modules/mod_jmlogin/assets/images/facebook.png'; ?>"/></a>
        <div class="clear"></div>
    </div>
</div>