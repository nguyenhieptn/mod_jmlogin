		...
		<div class="control-group">
			<div class="controls-label">
				<div class="jm-label-wrap clearfix">
					<label><?php echo JText::_("Please choose Email or Username");?></label>
				</div>
			</div>
			<div class="controls-content">
				<span class="float-left"><input type="radio" name="selecttype" value="email" checked="checked" /><?php echo JText::_("Email");?></span>
			...
			<div class="control-group typeselect" id="username_select" style="display: none;">
				<div class="controls-label">
					<div class="jm-label-wrap clearfix">
						<label for="re_uname"><?php echo $field_username; ?></label>
					</div>
				</div>
				<div class="controls-content">
			...
			<div class="control-group typeselect" id="email_select">
				<div class="controls-label">
					<div class="jm-label-wrap clearfix">
						<label for="re_inputEmail"><?php echo $field_email; ?></label>
					</div>
				</div>
				<div class="controls-content">
					<div class="jm-input-wrap clearfix">
