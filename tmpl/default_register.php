...
<div id="jmregister" class="jmregister jm-tab-content" >
		<div class="alert_register">Please waiting ...</div>
    <form action="<?php print JURI::root(true); ?>/modules/mod_jmlogin/ajax_register.php" method="GET" class="form-horizontal" id="form-register">
        <input type="hidden" name="link-base" value="<?php $link = (JURI::base()); echo $link; ?>" />
        <input type="hidden" name="register" value="register" />
        <div class="jm-control-group name">
        ...
        <div class="jm-control-group username">
            <div class="controls-label">
                <div class="jm-label-wrap clearfix">
        ...
        <div class="jm-control-group pass">
            <div class="controls-label">
                <div class="jm-label-wrap clearfix">
        ...
        <div class="jm-control-group pass_verify">
            <div class="controls-label">
                <div class="jm-label-wrap clearfix">
