...
<script type="text/javascript">
var jmmsg={
	JM_NAME : "<?php echo JText::_('JM_REQUIRED_NAME') ;?>",
	JM_USERNAME : "<?php echo JText::_('JM_REQUIRED_USERNAME') ;?>",
	JM_PASSWORD : "<?php echo JText::_('JM_REQUIRED_PASSWORD') ;?>",
	JM_CONFIRM_PASSWORD : "<?php echo JText::_('JM_REQUIRED_CONFIRM_PASSWORD') ;?>",
	JM_PASSWORD_NOT_MATCH : "<?php echo JText::_('JM_PASSWORD_NOT_MATCH') ;?>",
	JM_EMAIL : "<?php echo JText::_('JM_REQUIRED_EMAIL') ;?>",
	JM_EMAIL_INVALID : "<?php echo JText::_('JM_EMAIL_INVALID') ;?>",
