<?php
/**
 * @version		$Id: recaptcha.php 253 2009-01-07 23:56:26Z louis $
...
class JXRecaptcha extends JObject
{
	...
	function __construct($config = array())
	{
		...
		if ( isset( $config['server'] ) ) {
			...
			$this->_server = 'http://www.google.com/recaptcha/api';
		}
		...
		if ( isset( $config['secure_server'] ) ) {
			...
			$this->_secure_server = 'https://www.google.com/recaptcha/api';
		}
		...
		if ( isset( $config['verify_server'] ) ) {
			...
			$this->_verify_server = 'www.google.com';
		}
...
//                return $recaptcha_response;
        ...
        $response = $this->_http_post ($this->_verify_server, "/recaptcha/api/verify",
                                          array (
